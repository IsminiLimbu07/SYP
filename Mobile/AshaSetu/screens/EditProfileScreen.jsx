        ...
        try {
          ...
          if (token) {
            try {
              ...
              if (!profileRes.ok) {
                console.warn(`Profile fetch returned status ${profileRes.status}, skipping refresh`);
              } else {
              ...
              console.warn('⚠️ Could not refresh profile after upload:', profileErr.message);
              // Don't throw error - upload succeeded, just profile refresh failed
            }
          }
